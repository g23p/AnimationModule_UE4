...
// Cross Module References
	COMPONENTANIMATIONMODULE_API UScriptStruct* Z_Construct_UScriptStruct_FComponentAnimationStruct();
	...
	COMPONENTANIMATIONMODULE_API UFunction* Z_Construct_UFunction_UComponentAnimationHelper_MakeComponentAnimation();
...
class UScriptStruct* FComponentAnimationStruct::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern COMPONENTANIMATIONMODULE_API uint32 Get_Z_Construct_UScriptStruct_FComponentAnimationStruct_CRC();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FComponentAnimationStruct, Z_Construct_UPackage__Script_ComponentAnimationModule(), TEXT("ComponentAnimationStruct"), sizeof(FComponentAnimationStruct), Get_Z_Construct_UScriptStruct_FComponentAnimationStruct_CRC());
	}
	return Singleton;
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FComponentAnimationStruct(FComponentAnimationStruct::StaticStruct, TEXT("/Script/ComponentAnimationModule"), TEXT("ComponentAnimationStruct"), false, nullptr, nullptr);
static struct FScriptStruct_ComponentAnimationModule_StaticRegisterNativesFComponentAnimationStruct
{
	FScriptStruct_ComponentAnimationModule_StaticRegisterNativesFComponentAnimationStruct()
	{
...
} ScriptStruct_ComponentAnimationModule_StaticRegisterNativesFComponentAnimationStruct;
	...
	uint32 Get_Z_Construct_UScriptStruct_FComponentAnimationStruct_CRC() { return 3320480223U; }
	...
	UFunction* Z_Construct_UFunction_UComponentAnimationHelper_MakeComponentAnimation()
	{
		...
		if (!ReturnFunction)
		{
			...
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_NewRotation = { UE4CodeGen_Private::EPropertyClass::Struct, "NewRotation", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(ComponentAnimationHelper_eventMakeComponentAnimation_Parms, NewRotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FStructPropertyParams NewProp_NewVector = { UE4CodeGen_Private::EPropertyClass::Struct, "NewVector", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(ComponentAnimationHelper_eventMakeComponentAnimation_Parms, NewVector), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
			auto NewProp_IsIncrement_SetBit = [](void* Obj){ ((ComponentAnimationHelper_eventMakeComponentAnimation_Parms*)Obj)->IsIncrement = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_IsIncrement = { UE4CodeGen_Private::EPropertyClass::Bool, "IsIncrement", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(ComponentAnimationHelper_eventMakeComponentAnimation_Parms), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_IsIncrement_SetBit)>::SetBit, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Duration = { UE4CodeGen_Private::EPropertyClass::Float, "Duration", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(ComponentAnimationHelper_eventMakeComponentAnimation_Parms, Duration), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				...
				{ "CPP_Default_NewRotation", "0.000000,0.000000,0.000000" },
				{ "CPP_Default_NewVector", "0.000000,0.000000,0.000000" },
				{ "ModuleRelativePath", "Public/ComponentAnimationHelper.h" },
	...
	UClass* Z_Construct_UClass_UComponentAnimationHelper()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_UComponentAnimationHelper_MakeComponentAnimation, "MakeComponentAnimation" }, // 950955176
	...
	IMPLEMENT_CLASS(UComponentAnimationHelper, 369689453);
